    ...
    return (
      <>
        ...
        <div className="blog-details-cont">
          ...
          >
            <p className="blog-header">Bistro Blogs</p>
        ...
        <div className="blog-details">
          ...
          <div className="blog-details-info">
            ...
            <p className="blog-details-text">
              ...
              Officiis, ab veniam, amet ut at ipsum accusamus! Libero fugiat
              reiciendis architecto dignissimos, magnam iusto rerum recusandae
              quidem id omnis optio numquam.
            </p>
            ...
            <div>
              <blockquote className="blockquote1">
                ...
                <p className="quote-text">
                  ...
                  praesentium nihil quidem! Quaerat quibusdam, excepturi
                  mollitia cumque!
                </p>
              </blockquote>
              <div>
                <p className="blog-details-text">
                  Perspiciatis, tempore, voluptates! Officia minus quas illum
                  nam, beatae modi libero, harum aliquid totam quia nostrum
                  blanditiis accusamus a, illo unde consectetur! Velit, debitis
                  molestias eveniet consequuntur sit temporibus, ullam.
                </p>
                <p className="blog-details-text">
            ...
            <p className="blog-details-text">
              Tempore magnam quo reiciendis ullam quibusdam sit laboriosam
              tenetur nobis incidunt. Error culpa corporis aspernatur explicabo
              esse vero, nobis similique eaque quis repellendus dolore maiores!
              Molestiae beatae ratione quia a.
            </p>
            <p className="blog-details-text">
              Beatae quasi, totam officiis iste cum eaque maiores voluptatum qui
              eligendi doloribus pariatur explicabo expedita ullam, veritatis,
              eos libero numquam maxime cupiditate commodi repellat, illo
              provident! Quisquam rerum laudantium excepturi!
            </p>
          </div>
          <div className="detail-image-cont">
            <img
          ...
          <div className="blog-details-info">
            <div>
              ...
              <p className="blog-details-text">
                Exercitationem animi at quo voluptatum saepe, perferendis
                quisquam sequi, officiis, nostrum laudantium sapiente delectus!
                Totam, cupiditate qui necessitatibus natus assumenda labore
                adipisci amet commodi accusamus esse, itaque obcaecati at
                libero!
              </p>
            </div>
            ...
            <p className="blog-details-text">
              ...
              perferendis itaque totam ab. Eligendi et delectus, nulla aut
              quaerat in non nobis distinctio.
            </p>
            <p className="blog-details-text">
              Veniam nulla unde, rerum aut, porro nihil placeat voluptates
              inventore, laborum tempora dignissimos. Iste, placeat, aut? Quia
              ea tempore, temporibus quam eligendi, voluptates voluptatibus
              aperiam dolorum? Sequi dolorum consequatur accusantium.
            </p>
            <p className="blog-details-text">
